...
public class ElevateSecondObstacleRow : MonoBehaviour
{
    [SerializeField] public GameObject heightReference;

    private void OnTriggerEnter(Collider other)
    {
        // Find all objects with the tag
        GameObject[] obstacles = GameObject.FindGameObjectsWithTag("obst2");
